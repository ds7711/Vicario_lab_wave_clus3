...
function FileName = File_Detection(keyword, Data_Folder)
...
% in 'FileList'
% Data_Folder = uigetdir(Starting_Path, 'Select the Folder where the data is stored');  
FileList = dir(Data_Folder);
